<?php
	...
	if (sessionChange(1) == false){
		...
		$name = '../../../image/goods/'.md5($folder['name']).'/'.$name;
		$old = rename('../../../image/goods/'.md5($folder['name']).'/main.jpg', '../../../image/goods/'.md5($folder['name']).'/' . md5_file('../../../image/goods/'.md5($folder['name']).'/main.jpg') . '.jpg');
		
		$new = rename($name, '../../../image/goods/'.md5($folder['name']).'/main.jpg');
